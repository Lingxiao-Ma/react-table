(function (global, factory) {
  ...
  var useTable = function useTable(props) {
    ...
    var initializeRows = function initializeRows() {
      var rows = [];
      var flatRows = [];
      var rowsById = {};
    ...
    */
    ...
    var _initializeRows = initializeRows(),
        rows = _initializeRows[0],
        flatRows = _initializeRows[1],
        rowsById = _initializeRows[2];
